 ...
 * Contains all game logic and screens
 */
...
import { COLORS, ANSWER_DEBOUNCE_MS, SCORE_ANIMATION_MS } from '../../constants';
...
export const GameScreen: React.FC<GameScreenProps> = ({ name, onNameChange }) => {
  ...
  return <View style={styles.container}>{renderGameScreen()}</View>;
};
