    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-[260px] flex flex-col items-center gap-8">
        ...
        <div className="w-full flex flex-col items-center gap-6">
          <h1 className="text-xl font-semibold text-fg">Welcome</h1>

          <button
            onClick={handleGoogleAuth}
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-fg text-bg font-medium py-3 px-4 rounded-full hover:bg-fg/90 transition-all disabled:opacity-50"
          >
            {loading ? (
